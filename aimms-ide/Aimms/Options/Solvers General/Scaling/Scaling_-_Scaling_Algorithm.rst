...
*	AIMMS does not scale constraint programming models nor models with complementarity constraints. Scaling is also not applied to the robust counterpart of a model or the dual of a model.
