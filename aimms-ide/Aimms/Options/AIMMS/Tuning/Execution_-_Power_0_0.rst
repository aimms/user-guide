...
*  1 : Then 0^0 is 1, because the :math:`\lim \text{x} \downarrow 0` of x^0 is 1. In addition, this seems to be the predominant choice among software vendors for the operation 0^0. This is the default.
*	0 : Then 0^0 is 0, because the lim :math:`\lim \text{x} \downarrow 0` of 0^x is 0. In addition, defining 0^0 to be 0 results in more efficient execution as zeros can be skipped.
