...
*  1 : Then 0^0 is 1, because :math:`\lim_{x \to 0} x^0 = 1`. In addition, this seems to be the predominant choice among software vendors for the operation 0^0. This is the default.
*	0 : Then 0^0 is 0, because :math:`\lim_{x \to 0} 0^x = 0`. In addition, defining 0^0 to be 0 results in more efficient execution as zeros can be skipped.
