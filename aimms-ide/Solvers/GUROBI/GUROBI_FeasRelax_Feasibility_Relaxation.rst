...
After computing a minimum-cost relaxation (also referred to as 'Phase I'), Gurobi can optionally optimize the original objective among all solutions with a minimum-cost relaxation ('Phase II'). This can be enabled by setting the option :doc:`Feasibility_relaxation_optimiz <../../Aimms/Options/Solvers General/Infeasibility analysis/Feasibility_relaxation_optimiz>`.
...
*	:doc:`GUROBI_General_-_FeasRelax_big-M <General/GUROBI_General_-_FeasRelax_big-M>` 
