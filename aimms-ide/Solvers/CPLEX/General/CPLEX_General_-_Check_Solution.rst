...
By default, if the value of this option equals 'Yes' then AIMMS will print statistics that give information about the quality of
the solution. This is controlled by the option **Display Solution Statistics**. See the description of that option for more
information about the above quantities.
...
*	:doc:`CPLEX_General_-_Display_Solution_Statistics`  
*	:doc:`CPLEX_General_-_MemoryEmphasis`  
*	:doc:`../../../Aimms/Options/Solvers General/Postsolve/Postsolve_-_MIP_Calculate_Sensitivity_Info` 
